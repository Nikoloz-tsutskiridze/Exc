...
function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Image Navigation */}
      <div className="absolute top-1/2 left-0 transform -translate-y-1/2 flex space-x-4 z-20">
        <button
          onClick={() => changeImage(-1)}
          className="text-white bg-black p-4 rounded-full opacity-50 hover:opacity-100 sm:p-5 lg:p-6"
          style={{ zIndex: 999 }}
        >
          Prev
        </button>
